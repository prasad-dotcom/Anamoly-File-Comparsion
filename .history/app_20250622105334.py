...
# Split body into output blocks (e.g., each <div class="output">...</div>)
from bs4 import BeautifulSoup
soup = BeautifulSoup(body, "html.parser")
output_blocks = [str(div) for div in soup.find_all("div", class_="output")]

return render_template("first_page.html", output_blocks=output_blocks, file_name=user_file.filename)
